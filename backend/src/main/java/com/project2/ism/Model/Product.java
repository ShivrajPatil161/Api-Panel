...
public class Product {
    ...
    public Product(Long id, String productName, String productCode, Vendor vendor, String category, String model, String brand, String description, Integer warrantyPeriod, String warrantyType, String hsn, Boolean status, Integer minOrderQuantity, Integer maxOrderQuantity, String remarks, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
