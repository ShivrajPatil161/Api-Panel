...
import com.project2.ism.DTO.AesDTO.TokenGenerationRequest;
...
//	}
    ...
    public ResponseEntity<?> encryptCredentials(@RequestBody TokenGenerationRequest encryptDecryptCredentialsDto ) {
        try {
    ...
    public ResponseEntity<?> decryptCredentials(@RequestBody TokenGenerationRequest decryptCredentials) {
        try {
            // 1️ IV decode
            byte[] ivBytes = Base64.getDecoder().decode(decryptCredentials.getIvBase64());
