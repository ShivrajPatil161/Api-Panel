...
public class EnhancedSettlementController {
    ...
    public ResponseEntity<Map<String, Object>> processBatchWithTracking(
        ...
        try {
            ...
            // Note: Processing is triggered automatically in updateBatchCandidates
            // This endpoint just provides status confirmation
            return ResponseEntity.accepted().body(Map.of(
                    "batchId", batchId,
                    "status", "PROCESSING",
    ...
    /**
     * Get settlement candidates by cycle with product filtering (without creating batch)
     */
    @GetMapping("/candidates")
    public ResponseEntity<List<SettlementCandidateDTO>> getSettlementCandidatesByCycle(
            @PathVariable Long merchantId,
    ...
    /**
     * Get summary of recent batches for merchant dashboard
     */
    @GetMapping("/summary")
