...
//                 if (row.original.type === 'scheme') {
//                     return (
//                         <div className="font-bold text-gray-900 bg-gray-50 p-2 rounded">
//                             <div className="text-lg">{row.original.schemeCode}</div>
//                             <div className="text-sm text-gray-600">
...
//                         : 'bg-green-100 text-green-800'
//                         }`}>
//                         {row.original.customerType === 'franchise' ? 'Franchise' : 'Merchant'}
//                     </span>
//                 )
//             },
//         },
