...
const MerchantReports = () => {
    ...
    const exportConfig = {
        columns: {
            headers: ['Business Name', 'Franchise Name', 'Wallet Balance', 'Total Devices', 'Total Products','Contact Person','Contact Number','Contact Email','GST Number','PAN','Registration Number'],
            keys: ['businessName', 'franchiseName', 'walletBalance', 'totalDevices', 'totalProducts','contactPersonName','contactPersonPhoneNumber','contactPersonEmail','gstNumber','panNumber','registrationNumber'],
    ...
    useEffect(() => {
        const fetchReports = async () => {
            try {
                setLoading(true);
                const response = await api.get('/stats/merchant-reports');
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Merchant Reports</h1>
                    <p className="text-sm text-gray-600">Overview of merchant performance metrics and details</p>
                </div>
                <UniversalExportButtons
                    data={data}
                    filename="merchant-reports"
