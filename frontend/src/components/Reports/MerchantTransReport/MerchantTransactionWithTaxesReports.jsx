// MerchantTransactionWithTaxesReports.jsx
...
const MerchantTransactionWithTaxesReports = ({ filters: commonFilters, userType }) => {
        ...
        try {
            ...
            if (localFilters.selectedMerchant === 'ALL') {
                const exportParams = {
                    ...
                    includeTaxes: true, // optional; change if you need taxes included
                };
    ...
    const columnPriority = [
        ...
        'systemFee','systemFeeExGST','gstAmount', 'commissionAmount', 'merchantName', 'franchiseName', 'brandType',
    ...
    const exportConfig = useMemo(() => {
        const fieldMapping = {
            ...
            gstAmount: { header: 'GST Amount (₹)', format: val => val },
...
export default MerchantTransactionWithTaxesReports;